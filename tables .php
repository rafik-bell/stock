...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">2</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[1][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">3</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[2][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">4</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[3][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">5</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[4][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">6</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[5][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">7</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[6][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">8</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[7][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">9</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[8][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
...
if (mysqli_num_rows($result) > 0) { while($row = mysqli_fetch_assoc($result)) {
  ...
  ?>
    ...
    <tr>
      <th scope="row">10</th>
      <td>
      <select class="form-control select2 select2-hidden-accessible " style="width: 100%;  height: 100%;" name="data[9][name]" tabindex="-1" name="forn_name" aria-hidden="true">
                    <option selected="selected">اسم</option>
                    <?php  $sql = "SELECT * FROM `produit`";
  $result = mysqli_query($conn, $sql);
